...
class AdvanceBillingVC: UIViewController {
    ...
    func setup()
    {
        ...
        let controller1 = AdvanceBillingPaymentVC(nibName: "AdvanceBillingPaymentVC", bundle: nil)
        controller1.title = "ADVANCE BILLING PAYMENT"
        controllerArray.append(controller1)
        
        let controller2 = AdvanceBillingPaymentVC(nibName: "AdvanceBillingPaymentVC", bundle: nil)
        controller2.title = "ADVANCE BILLING RECEIPT "
