...
class ProcedureBillingVC: UIViewController {
    ...
    func setup()
    {
        ...
        let controller1 = ProcedureBillingPaymentVC(nibName: "ProcedureBillingPaymentVC", bundle: nil)
